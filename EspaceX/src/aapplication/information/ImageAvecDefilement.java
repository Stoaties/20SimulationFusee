...
public class ImageAvecDefilement extends JPanel {//debut classe
	...
	//Constructeur
	//Caroline H
	public ImageAvecDefilement() {//debut constructeur
		super();
		...
		accelererBarreDefielement();
		setLayout(null);
		add(sp); //ajout du scrollpane au jpanel
	}//fin constructeur
	
	/**
	 * Methode qui permet de faire bouger la barre de defilement plus rapidement avec la molettede la souris
	 */
	//Melie L
	private void accelererBarreDefielement() {//debut methode
		sp.getVerticalScrollBar().setUnitIncrement(16);//Faire bouger la barre plus vite
	}//fin methode
	 ...
	 */
	//Caroline H
	public void setFichierImage(String nomFichierImage) {//debut methode
	 ...
	 */
	//Caroline H
	public void setLargeurCadre(int largeurCadre) {//debut methode
	 ...
	 */
	//Caroline H
	public int getLargeurCadre() {//debut methode
		return largeurCadre;
	}//fin methode
